...
OUTPUT = ROOT / "artifacts/imagenet1k-baseline-head300-30e-cosine-systematic300"
METHOD = "baseline"  # "baseline", "class", "margin"
...
metrics = {
    "run": {
        ...
        "delegation_note": "Table 4 baseline uses student_only; it has no class-based delegation.",
